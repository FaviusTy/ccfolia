  ...
  return (
    <>
      ...
      <Route
        exact
        path={`${url}/datasheats`}
        render={() => <Frame onClose={() => replace(url)} title="DataSheats" />}
      />
      <Route
        exact
        path={`${url}/objects`}
        render={() => <Frame onClose={() => replace(url)} title="Objects" />}
      />
      <Route
        exact
        path={`${url}/effects`}
        render={() => <Frame onClose={() => replace(url)} title="Effects" />}
      />
      <Route
        exact
        path={`${url}/media`}
      ...
      <Route
        exact
        path={`${url}/notes`}
        render={() => <Frame onClose={() => replace(url)} title="Notes" />}
      />
      <Table id={id} table={table} />
      <Messages id={id} messages={messages} />
      <ChatBox id={id} />
      <MenuSide onBack={goBack} />
