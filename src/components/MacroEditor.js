...
const TableMacroEditor = () => {
  return (<div className="MacroEditor">
    <div>
      <h2>CLEAR</h2>
      ...
      <label>size:</label> <input type="text" defaultValue="field[col]" /> <input type="text" defaultValue="field[row]" />
      ...
      <label>volume:</label> <input type="text" defaultValue="media[volume]" />
      <h2>OBJECTS</h2>
      <label>id:</label> <input type="text" defaultValue="id" />
      <label>url:</label> <input type="text" defaultValue="url" />
      <label>size:</label> <input type="text" defaultValue="w" /> <input type="text" defaultValue="h" />
      <label>position:</label> <input type="text" defaultValue="x" /> <input type="text" defaultValue="y" />
      <h2>MARKER</h2>
    </div>
  </div>)
}
...
const CharacterMacroEditor = () => {
  return (<div className="MacroEditor">
    <div>
      ...
      <label>size:</label> <input type="text" defaultValue="x" /> <input type="text" defaultValue="y" />
      <label>position:</label> <input type="text" defaultValue="w" /> <input type="text" defaultValue="h" />
    </div>
  </div>)
}
